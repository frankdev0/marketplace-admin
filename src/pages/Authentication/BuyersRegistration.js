...
const BuyersRegistration = () => {
  const [buyerRegisterDetail, setBuyerRegisterDetail] = useState({
    firstName: "",
    lastName: "",
    email: "",
    password: "",
  ...
  const handleSubmit = async (e) => {
    ...
    e.preventDefault();
    try {
      console.log(buyerRegisterDetail);
      console.log(phoneValue);
      const buyerRegistration = {
        firstName: buyerRegisterDetail.firstName,
        LastName: buyerRegisterDetail.lastName,
        email: buyerRegisterDetail.email,
        phoneNumber: phoneValue,
        role: "BUYER",
        password: buyerRegisterDetail.password,
      };
      const {
        data: { data },
      } = await axios.post(`/auth/register-user`, buyerRegistration);
                  ...
                  <form className="auth-form" onSubmit={handleSubmit}>
                    <div class="mb-3">
                      ...
                      <input
                        ...
                        name="firstName"
                        value={buyerRegisterDetail.firstName}
                    ...
                    <div class="mb-3">
                      ...
                      <input
                        ...
                        aria-describedby="emailHelp"
                        name="lastName"
                        value={buyerRegisterDetail.lastName}
                        onChange={handleChange}
                      />
                    ...
                    <div class="mb-3">
                      ...
                      <input
                        ...
                        aria-describedby="emailHelp"
                        name="email"
                        value={buyerRegisterDetail.email}
                        onChange={handleChange}
                      />
                    ...
                    <div class="mb-3">
                      ...
                      <div className="form-control passwordToggle">
                        <input
                          ...
                          name="password"
                          value={buyerRegisterDetail.password}
                          onChange={handleChange}
